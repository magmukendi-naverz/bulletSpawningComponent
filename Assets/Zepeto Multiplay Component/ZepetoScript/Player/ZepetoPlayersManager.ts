...
export default class ZepetoPlayersManager extends ZepetoScriptBehaviour {
    ...
    private _localPlayer: ZepetoCharacter;
    ...
    private Start() {
        switch (+this.ZepetoPlayerSpawnType){
            ...
            case ZepetoPlayerSpawnType.MultiplayerSpawnLater:
                ...
                this._multiplay.RoomReconnected += (room: Room) => {
                ...
                {
                    this._localPlayer = ZepetoPlayers.instance.LocalPlayer.zepetoPlayer.character;
                    this._localPlayer = ZepetoPlayers.instance.LocalPlayer.zepetoPlayer.character;
